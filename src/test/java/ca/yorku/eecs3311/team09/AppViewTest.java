...
public class AppViewTest {
	...
	public void AppViewTest01() {
		...
		Assert.assertEquals("Incorrect number of countries were added", 2, view.getCountriesList().getItemCount());

		Assert.assertEquals("Incorrect number of countries were added", "India",
				view.getCountriesList().getItemAt(0).getName());

		Assert.assertEquals("Incorrect number of countries were added", "Canada",
	...
	public void AppViewTest02() {
		...
		Assert.assertEquals("Incorrect number of countries were added", "India", view.getSelectedCountry().getName());

		view.getCountriesList().setSelectedIndex(1);
		Assert.assertEquals("Incorrect number of countries were added", "Canada", view.getSelectedCountry().getName());
	}
	...
	public void AppViewTest03() {
		...
		for (Integer year = 2000, i = 0; year <= 2010; year++, i++) {
			...
			Assert.assertEquals("Incorrect from date added/returned", year, view.getSelectedFromDate());
		...
		for (Integer year = 2010, i = 0; year >= 2000; year--, i++) {
			...
			Assert.assertEquals("Incorrect to date added/returned", year, view.getSelectedToDate());
	...
	public void AppViewTest04() {
		...
		Assert.assertEquals("Plot view was not added", panel, view.getCenter().getComponent(0));
	}
	...
	public void AppViewTest05() {
		...
		Assert.assertEquals("Plot views were not added", 2, view.getCenter().getComponentCount());

		view.removePlotView(0);

		Assert.assertEquals("Plot view was not removed", 1, view.getCenter().getComponentCount());

		Assert.assertEquals("Wrong plot view removed", panel2, view.getCenter().getComponent(0));
	}
	...
	public void AppViewTest06() {
		...
		Assert.assertTrue("Plot creation was not deferred to the controller", AppViewTest.plotCreated);
	}
	...
	public void AppViewTest07() {
		...
		Assert.assertTrue("Plot deletion was not deferred to the controller", AppViewTest.plotDeleted);
	}
	...
	public void AppViewTest08() {
		...
		Assert.assertTrue("Plot deletion was not deferred to the controller", AppViewTest.plotRecalculated);
	}
	...
	public void AppViewTest09() {
		...
		Assert.assertEquals("Plot view was not updated", panel2, view.getCenter().getComponent(0));
	}
	...
	public void AppViewTest10() {
		...
		Assert.assertTrue("Plot selection border was not added", panel.getBorder().isBorderOpaque());

		view.removePlotHighlight(0);

		Assert.assertFalse("Plot selection border was not removed", panel.getBorder().isBorderOpaque());
	}
}